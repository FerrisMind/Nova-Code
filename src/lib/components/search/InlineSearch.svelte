<script lang="ts">
  ...
  import { inlineSearchStore } from '$lib/stores/searchStore';
  ...
  const searchState = $derived($inlineSearchStore);
  ...
  function findNext(): void {
    if (!editor) return;
    editor.trigger('inlineSearch', 'editor.action.nextMatchFindAction', null);
  }
  ...
  function findPrevious(): void {
    if (!editor) return;
    editor.trigger('inlineSearch', 'editor.action.previousMatchFindAction', null);
  }
...
{#if searchState.visible}
  <div class="inline-search-panel" role="dialog" aria-label="Find and Replace">
    <div class="search-row">
      ...
      <div class="nav-buttons">
        ...
        <button class="close-btn" onclick={close} title="Close (Esc)" aria-label="Close search">
          ✕
        </button>
      </div>
    </div>
      ...
      <div class="replace-row">
        ...
        <div class="input-group">
          <input
            ...
            oninput={(e) => inlineSearchStore.setReplaceText(e.currentTarget.value)}
            onkeydown={handleKeydown}
        ...
        <div class="replace-buttons">
          <button class="action-btn" onclick={replace} title="Replace"> Replace </button>
          <button class="action-btn" onclick={replaceAll} title="Replace All"> Replace All </button>
        </div>
      </div>
    {/if}
  </div>
